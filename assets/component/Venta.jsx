  ...
  return (
    <View style={styles.container}>
      <View style={{ backgroundColor: "#fffafa" }}>
        ...
        >
          Bienvenido(a) a la seccion de ventas
        </Text>
      </View>
      <View>
        ...
        <Controller
          ...
          rules={{
            ...
            pattern: {
              ...
              message: "Formato mm/dd/yy o m/dyyyy ",
            },
          }}
          render={({ field: { onChange, onBlur, value } }) => (
            <TextInput
              style={[
                styles.inputs,
                { borderColor: errors.fecha ? "#df5b5b" : "#eeeeee" },
              ]}
              onBlur={onBlur}
              onChangeText={onChange}
              value={value}
      ...
      <View>
        ...
        <Controller
          ...
          rules={{
            ...
            max: {
              value: 1000000000,
              message: "Se permite maximo 1000 millones",
            },
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <TextInput
              style={[
                styles.inputs,
                { borderColor: errors.valorVenta ? "#df5b5b" : "#eeeeee" },
              ]}
              onBlur={onBlur}
              onChangeText={onChange}
              value={value}
